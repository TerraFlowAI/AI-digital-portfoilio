...
import { Mic, Waves, AudioLines } from 'lucide-react';
...
export const metadata: Metadata = {
  ...
  description: 'Shamanth - AI Engineer & Frontend Developer. Crafting intelligent systems and intuitive user experiences.',
};
